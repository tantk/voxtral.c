...
inspect: scripts/tools/inspect_weights.o voxtral_safetensors.o
...
# =============================================================================
clean:
	rm -f $(OBJS) voxtral_cuda.o voxtral_cuda_quant.o *.mps.o voxtral_metal.o main.o scripts/tools/inspect_weights.o $(TARGET) inspect_weights
...
scripts/tools/inspect_weights.o: scripts/tools/inspect_weights.c voxtral_safetensors.h
	$(CC) $(CFLAGS) -I. -c -o $@ $<
